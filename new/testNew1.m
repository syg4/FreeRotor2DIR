...
lineshapeForm = '1fast';
lineshapeParams = struct('T2',40000);
...
J1 = getJ1(roVibDensityMatrix, transDipoleMatrixZ, t1TimeProp);
...
fig3 = figure(3);
clf
my2dPlot(freq1, freq3, real(Rcrop),'pumpprobe',false,'n_contours',6, 'zlimit', 1)
